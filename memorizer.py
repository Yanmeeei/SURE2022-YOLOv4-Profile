...
class MemRec(object):
    ...
    def report(self, sample=False):
        ...
        plt.savefig("layer-avg_mem_self_cpu_head.png")
        ...
        plt.savefig("layer-avg_mem_cpu_head.png")
        ...
        if self.mem_cuda:
            ...
            plt.savefig("layer-avg_mem_self_cuda_head.png")
            ...
            plt.savefig("layer-avg_mem_cuda_head.png")
